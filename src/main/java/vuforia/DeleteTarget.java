...
/**
 * See the Vuforia Web Services Developer API Specification -
 * https://developer.vuforia.com/resources/dev-guide/managing-targets-cloud-database-using-developer-api
 * Note: a target that has status of �Processing� cannot be deleted. Note: a
 * target must be inactive in order to be deleted. To deactivate a target, set
 * its active_flag to false using the PUT method as demonstrated below. You can
 * also confirm the activation status of the target in the Target Manager at
 * http://developer.vuforia.com.
 */
public class DeleteTarget implements TargetStatusListener {

    //Server Keys
    protected static final String accessKey = "c21a902956eb0c520874dba1a331ed82da131e13";
    protected static final String secretKey =  "9fdb52e14e306000452c7524ad1b79a1895244f8";
