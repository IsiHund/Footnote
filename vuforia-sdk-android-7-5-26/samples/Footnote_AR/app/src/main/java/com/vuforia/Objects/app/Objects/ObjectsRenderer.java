...
// The renderer class for the Objects sample.
public class ObjectsRenderer implements GLSurfaceView.Renderer, SampleAppRendererControl
{
    SampleApplicationSession vuforiaAppSession;
    SampleAppRenderer mSampleAppRenderer;

    // Texture is Generated and Target is Acquired - Rendering Object Data
    ...
    // New Target has been found - Loading Object data and generating OpenGL
    // Textures
    public static final int RS_LOADING = 3;
    
    // Texture with Object data has been generated in Java - Ready to be generated
    // in OpenGL in the renderFrame thread
    public static final int RS_TEXTURE_GENERATED = 4;
    
    // Objects is active and scanning - Searching for targets.
    public static final int RS_SCANNING = 5;
    
    private boolean mIsActive = false;

    // Reference to main activity
    public WeakReference<Objects> mActivityRef;
    ...
    public ObjectsRenderer(Objects activity, SampleApplicationSession appSession)
    {
        ...
        mSampleAppRenderer = new SampleAppRenderer(this, mActivityRef.get(), Device.MODE.MODE_AR, false, 0.010f, 5f);
    }
    ...
    public void renderFrame(State state, float[] projectionMatrix)
    {
        ...
        // generates
        // the OpenGL texture for start drawing the plane with the Object data
        ...
        if (!state.getTrackableResults().empty())
        {
            ...
            // Renders the Augmentation View with the 3D Object data Panel
    ...
    {
        // Initialize the animation values when the Object data
    ...
    private void renderAugmentation(TrackableResult trackableResult, float[] projectionMatrix)
    {
        ...
        SampleUtils.checkGLError("Objects renderFrame");
