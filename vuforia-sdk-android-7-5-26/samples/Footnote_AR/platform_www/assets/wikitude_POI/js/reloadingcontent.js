...
var World = {
  ...
  */
  ...
  requestDataFromServer: function requestDataFromServerFn(lat, lon) {
    ...
    $.ajaxSetup({
      headers: {
        'Authorization': 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJMb2dpbl9BdXRoX0Zvb3Rub3RlIiwianRpIjoiOSIsImV4cCI6MTU1MTAyNDM4MywiaWQiOjksInJvbGUiOiJVU0VSIn0.fCFxQGskY8nm-pzRdjpnQqxBeFOWSRqV9r7RBhupPuo'
      }
    });
    var jqxhr = $.getJSON('http://vm68.htl-leonding.ac.at/javaendpoint/footnote/rest/realObject', function (data) {
